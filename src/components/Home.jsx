        ...
        <section className="products">
          ...
          <div className="samples">
            <div className="product-item">
              <img src="/images/pexels-yaroslav-shuraev-8889716.jpg" alt="A watering can" className="product-image" />
              <p>Watering cans</p>
            ...
            <div className="product-item">
              <img src="/images/pexels-greta-hoffman-7728012.jpg" alt="Seedling trays" className="product-image" />
            ...
            <div className="product-item">
              <img src="/images/pexels-shvetsa-5231223.jpg" alt="Plants in a greenhouse" className="product-image" />
